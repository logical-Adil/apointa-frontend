        ...
        <div className="animate-fade-up w-full max-w-lg px-1 text-center sm:px-0">
          ...
          <div className="mt-10 flex w-full max-w-md flex-col gap-3 sm:mx-auto sm:flex-row sm:justify-center">
            <button
              type="button"
              onClick={reset}
              className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-accent px-6 text-sm font-semibold text-[#0B0F13] shadow-lg shadow-accent/20 transition-all duration-200 hover:bg-accent-hover hover:shadow-accent/30 sm:w-auto sm:min-w-[10.5rem]"
            >
              <RetryIcon />
              Try again
            </button>
